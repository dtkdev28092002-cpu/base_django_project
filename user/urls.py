...
urlpatterns = [
    ...
    path("tags/me/", TagMeListView.as_view(), name="tag-me"),
    ...
    path("posts/me/", PostMeListView.as_view(), name="post-me"),
    ...
    path("comments/me/", CommentMeListView.as_view(), name="comment-me"),
